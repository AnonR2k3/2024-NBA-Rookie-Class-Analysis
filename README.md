...
<img width="1790" height="598" alt="image" src="https://github.com/user-attachments/assets/73d5af1e-25c0-49ee-9de8-3e97e84b53df" />

**Chart 2**
Analyses where each pick's Game Score averages stand commpared to the league average and organized performance by colour. All of these classes hold either 2 or 3 players that perform slighlty above league average. 
<img width="1790" height="593" alt="image" src="https://github.com/user-attachments/assets/bdb80b52-100d-41ab-ad2b-4792dc67c43e" />

**Chart 3**
Taking into account evolving offenses in the NBA, I created a visual that displays both the class average and league average to determine how each class holds in their respective eras. To compare, I added the same visualizations for the draft classes immediately preceding the weak classes. This proves that rookies can contribute immediately and these classes just lack the talent to do so. 
<img width="1635" height="1112" alt="image" src="https://github.com/user-attachments/assets/a0b72048-0d69-4f6b-8ed8-e8addac9238a" />
